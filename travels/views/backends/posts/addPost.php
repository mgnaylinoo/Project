<div class="col-md-9" style="position: relative;">
    <div class="row overflow-div">
      <div style="margin-left:80px ;">
        <h2 class="pt-4 text-white"><i class="fa-solid fa-plus" style="margin-right:12px"></i>Add Post</h2>
      </div>
    </div>
    <?php 
...
enctype="multipart/form-data">
  ...
  <div class="row">
    <div class="col">
    <textarea name="description" id="description" cols="71" rows="10" ></textarea>
    <?php
  ...
  <div class="text-center">
    <button type="submit" class="btn btn-success"><i class="fa-solid fa-circle-plus"></i>Post</button>
